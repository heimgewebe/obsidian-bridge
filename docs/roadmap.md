...
- [x] **Layout-Typen pro Canvas-Klasse implementieren:** (teilweise / scaffold angelegt - aktuell Grid-Layout)
...
- [x] **Phase 2 – Deterministische Canvas-Renderer** (teilweise - Layout-Klassen fehlen noch)
